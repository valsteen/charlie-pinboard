...
from repo_work.actions import Action, AuthorizationKind, Role, actions_for, coordinator_generation, state_revision
...
from repo_work.leases import LeaseError, require_attempt, require_coordination
from repo_work.markdown import parse_item, parse_queue
from repo_work.resources import ResourceError, require_resource
    ...
    *,
    ...
    try:
        with authority_transaction(work_root) as authority:
            ...
            value = parse_transition_input(action.kind.value, payload)
