...
class DispatchErrorCode(Enum):
    ...
    DISPATCH_VERIFICATION_INCOMPLETE = "DISPATCH_VERIFICATION_INCOMPLETE"
    DISPATCH_VERIFICATION_INVALID = "DISPATCH_VERIFICATION_INVALID"
    DISPATCH_VERIFICATION_MISSING = "DISPATCH_VERIFICATION_MISSING"
