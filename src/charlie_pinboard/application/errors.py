...
class MutationContractErrorCode(Enum):
    ...
    ATTEMPT_MISSING_OR_BEFORE_STATE_STALE = "MUTATION_ATTEMPT_MISSING_OR_BEFORE_STATE_STALE"
    ...
    PROPOSAL_RELATION_TARGET_MISSING = "MUTATION_PROPOSAL_RELATION_TARGET_MISSING"
