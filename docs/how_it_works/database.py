...
DIAGRAM = Diagram(
    ...
    sections=(
        ...
        Section("Durable knowledge", "accepted files connected by role", 28, 432),
        Section("Mutation ownership", "shared and per-attempt leases", 424, 432),
    ...
    notes=(
        ...
        Note(
            "Attached knowledge links an item and role to immutable bytes. Attempts retain their own brief and result references.",
            28,
            816,
            11,
        ),
