...
def build_outputs(root: Path) -> dict[Path, str]:
    ...
    for diagram in diagrams:
        outputs[OUTPUT_PATHS[diagram.slug]] = render_svg(diagram, source_revision, DAY_PALETTE)
        outputs[DARK_OUTPUT_PATHS[diagram.slug]] = render_svg(diagram, source_revision, NIGHT_PALETTE)
