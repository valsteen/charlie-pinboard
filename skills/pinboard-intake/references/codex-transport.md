...
If task messaging is unavailable, do not reconstruct it with shell commands, issue comments, commits, or public files. Leave the immutable proposal in the inbox; optional transport needs no user-facing report by default.
