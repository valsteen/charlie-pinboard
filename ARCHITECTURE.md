...
| `action_selection.py`, `transition_models.py`, `transition_input.py`, `transitions.py` | Advertised-action reselection, strict transition and complete definition-replacement payloads, typed conversion, checkpoint identity checks, coordination lifetime, and transition presentation |
